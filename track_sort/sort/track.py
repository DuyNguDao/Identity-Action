import cv2
import numpy as np
from track_sort.sort.kalman_filter import KalmanFilter
...
class Track:
    ...
    def __init__(self, detection, track_id, conf, kpt, n_init, max_age):
        ...
        self.keypoints_list = deque(maxlen=15)
        self.keypoints_list.append(kpt)
    ...
    def update(self, detection, conf, kpt):
